...
(function () {
  ...
  var I18N = {
    ...
    en: {
      ...
      "compare.title": "Same messages. <em>Very different outcome.</em>",
      "compare.withoutTitle": "Without OwnerDeck",
      "compare.withTitle": "With OwnerDeck",
      "compare.w1": "You reply when you get a chance — minutes or hours later",
      "compare.w2": "Messages pile up during busy hours and overnight",
      "compare.w3": "Bookings quietly go to faster competitors",
      "compare.w4": "You type the same answers over and over",
      "compare.g1": "Every message answered in seconds — 24/7",
      "compare.g2": "Replies automatically in the customer's language",
      "compare.g3": "Bookings captured and logged for you",
      "compare.g4": "You get pinged only when it needs you",

      "price.roi": "💡 <b>€150/month is roughly one recovered booking.</b> The assistant only has to save a handful to pay for itself.",

      "tl.eyebrow": "Getting started",
      "tl.title": "Live in 48 hours. <em>Here's how.</em>",
      "tl.s1.title": "You reach out — 2 minutes",
      "tl.s1.body": "Fill in the short form below. No commitment, no sales call.",
      "tl.s2.title": "We learn your business",
      "tl.s2.body": "Your services, prices, hours and the questions customers actually ask.",
      "tl.s3.title": "We build & train your assistant",
      "tl.s3.body": "Connected to your WhatsApp Business number, sounding like you.",
      "tl.s4.title": "You review and approve",
      "tl.s4.body": "Nothing goes live until you're happy with how it replies.",
      "tl.s5.title": "It goes live",
      "tl.s5.body": "Your assistant starts answering customers — while you get on with the work.",
