...
(function () {
  ...
  var I18N = {
    /* ---------------------------------------------------------- EN */
    en: {
      "meta.title": "Ownerdeck — Your business's WhatsApp, handled.",
      ...
      "hero.title": "The AI that answers your business's <span class=\"accent\">WhatsApp</span> — and takes the booking.",
      "hero.lede": "Ownerdeck lives on your own WhatsApp number. It replies in two seconds, in any language, quotes real availability and prices, and captures bookings — while you sleep.",
      ...
      "problem.c3.t": "You can't be on the phone all day",
      "problem.c3.b": "Every call you miss while you work is a booking that walks to a competitor.",
      ...
      "how.s1.t": "Customer messages your WhatsApp",
      "how.s1.b": "Same number they already use. No new app, no form, no waiting till morning.",
      ...
      "caps.c4.t": "Human handoff anytime",
      "caps.c4.b": "Flip a conversation to manual and the bot steps back. Complaints and edge cases route to a human, never the bot.",
      ...
      "price.f1": "Your own WhatsApp number, fully managed",
    ...
    /* ---------------------------------------------------------- EL */
    el: {
      "meta.title": "Ownerdeck — Το WhatsApp της επιχείρησής σας, σε καλά χέρια.",
      "nav.how": "Πώς λειτουργεί",
      "nav.features": "Δυνατότητες",
      "nav.pricing": "Τιμές",
      "nav.faq": "Συχνές ερωτήσεις",
      "cta.demo": "Κλείστε demo",
      "cta.seeHow": "Δείτε πώς λειτουργεί",

      "hero.pill": "Ζωντανά τώρα · πραγματικές κρατήσεις 24/7",
      "hero.title": "Η τεχνητή νοημοσύνη που απαντά στο <span class=\"accent\">WhatsApp</span> της επιχείρησής σας — και κλείνει την κράτηση.",
      "hero.lede": "Το Ownerdeck ζει στον δικό σας αριθμό WhatsApp. Απαντά σε δύο δευτερόλεπτα, σε οποιαδήποτε γλώσσα, δίνει πραγματική διαθεσιμότητα και τιμές και καταγράφει κρατήσεις — ενώ εσείς κοιμάστε.",
      ...
      "problem.c3.t": "Δεν μπορείτε να είστε στο τηλέφωνο όλη μέρα",
      "problem.c3.b": "Κάθε κλήση που χάνετε όσο δουλεύετε είναι μια κράτηση που πάει σε ανταγωνιστή.",
      ...
      "how.s1.t": "Ο πελάτης στέλνει μήνυμα στο WhatsApp σας",
      "how.s1.b": "Ο ίδιος αριθμός που ήδη χρησιμοποιούν. Χωρίς νέα εφαρμογή, χωρίς φόρμα, χωρίς αναμονή μέχρι το πρωί.",
      ...
      "caps.c4.t": "Παράδοση σε άνθρωπο ανά πάσα στιγμή",
      "caps.c4.b": "Γυρίστε μια συνομιλία σε χειροκίνητη λειτουργία και το bot αποσύρεται. Παράπονα και ειδικές περιπτώσεις πάνε πάντα σε άνθρωπο.",
      ...
      "price.f1": "Ο δικός σας αριθμός WhatsApp, πλήρως διαχειριζόμενος",
      ...
      "faq.a1": "Όχι. Οι πελάτες σας στέλνουν μήνυμα στον υπάρχοντα αριθμό σας στο WhatsApp ακριβώς όπως κάνουν σήμερα. Τίποτα δεν αλλάζει για εκείνους — δεν χρειάζονται νέα εφαρμογή, λογαριασμό ή σύνδεσμο.",
    ...
    /* ---------------------------------------------------------- RU */
    ru: {
      "meta.title": "Ownerdeck — WhatsApp вашего бизнеса под контролем.",
      ...
      "hero.title": "ИИ, который отвечает в <span class=\"accent\">WhatsApp</span> вашего бизнеса — и оформляет бронь.",
      "hero.lede": "Ownerdeck живёт на вашем собственном номере WhatsApp. Отвечает за две секунды, на любом языке, называет реальную доступность и цены и оформляет брони — пока вы спите.",
      ...
      "problem.c3.t": "Нельзя сидеть в телефоне весь день",
      "problem.c3.b": "Каждый пропущенный звонок во время работы — это бронь, ушедшая конкуренту.",
      ...
      "how.s1.t": "Клиент пишет в ваш WhatsApp",
      "how.s1.b": "Тот же номер, что и всегда. Без нового приложения, без формы, без ожидания до утра.",
      ...
      "caps.c4.t": "Передача человеку в любой момент",
      "caps.c4.b": "Переведите диалог в ручной режим — и бот отступает. Жалобы и сложные случаи всегда идут человеку.",
      ...
      "price.f1": "Ваш собственный номер WhatsApp, под полным управлением",
      ...
      "faq.a1": "Нет. Ваши клиенты пишут на ваш существующий номер WhatsApp точно так же, как и сегодня. Для них ничего не меняется — не нужно новое приложение, аккаунт или ссылка.",
